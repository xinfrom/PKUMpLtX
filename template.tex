...
% \date{\releasedate}
\begin{abstract}
本实验通过膨胀法校准真空计，用一级膨胀系统在$10^-3$ - 1Torr范围内进行校准。
...
\section{引言}
“真空”泛指低于一个大气压的气体充满的空间状态。真空技术是基本实验技术之一，在许多实验室中都有重要应用。
本实验主要实验内容是测量真空环境的压强，并比较真空计示数进而校准真空计。
...
整个系统先用机械泵-扩散泵系统抽至高真空，关闭活塞B、C和D，
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{fig/data7.png}
  \caption{真空计校准实验数据}
  \label{sec:data7}
\end{figure}

可以看到实验数据大致满足y=x的关系，分区间看会发现随着压强增大，斜率逐渐小于1。
这说明压强变大时，测量计算得到的压强偏大。

原因分析：1、压强较低时每次取出的气体较少，$p_0$基本不变，压强较高时$p_0$的改变相较较大，不能当成常量迭代。
