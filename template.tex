...
法3：在晶体上加交流电压，调节晶体上直流电压。
A垂直P时，当$V_{D0}$ = -162V时，输出光极弱，示波器上观测到光强随时间变化频率为2f，此时相位差为0。
A平行P时，当$V_{DP}$ = 1244V时，输出光极弱，示波器上观测到光强随时间变化频率为2f，此时相位差为$\pi$。$V_{\pi3} = 5624V$

根据法2得到的半波电压计算得电光系数$r_{63}$ = 15.3 × ${10}^{-10}cm \cdot V^{-1}$
...
根据$V_{\pi2}$及理论中的公式计算得：$\delta n = 0.0035$
