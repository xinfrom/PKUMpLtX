...
康普顿散射从实验上证实了光子是具有能量$E = \omega$和动量$p = k$的粒子，在微观的光子和电子的相互作用过程中，能量与动量守恒仍然成立。
...
微分截面定义：一个能量为hv的入射$\gamma$光子与原子中的一个核外电子作用后散射到$\theta$方向单位立体角里的概率，记作$\frac{d \sigma (\theta)}{d \Omega}$
